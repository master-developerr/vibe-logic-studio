...
The fastest way to connect is with the [Clerk CLI](https://clerk.com/docs/cli.md). Run the following command to detect the AI clients installed on your machine and register Clerk's MCP server in each one you select:
